...
import { User, Profile, Project } from "@prisma/client";
import { SearchFilters } from "@/features/users/services/searchService";
...
export const searchService = {
  async searchStudents(filters: SearchFilters, pageSize = 15, cursor?: any): Promise<ServiceResult<any>> {
    return handleServiceCall(async () => {
      const where: any = {
